...
enum GameFlags {
    ...
    GF_WhaleDefeated                            = GameFlag(0x00E),
    GF_KoopaBrosDefeated                        = GameFlag(0x00F),
    GF_BowserDefeated                           = GameFlag(0x010),
    GF_CreditsSeen                              = GameFlag(0x011),
    GF_IntroSeen                                = GameFlag(0x012),
    GF_StartedSpaceShip                            = GameFlag(0x013),
    GF_LearnedToShoot                            = GameFlag(0x014),
