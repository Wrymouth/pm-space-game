...
EvtScript N(OpeningCutscene) = {
    ...
    EVT_SET(MV_ShipPosX, -248)
    EVT_SET(MV_ShipPosY, -181)
    EVT_CALL(TranslateGroup, Model_Spaceship, -248, -181, 0)
    EVT_CALL(DisablePlayerInput, TRUE)
    EVT_CALL(DisablePlayerPhysics, TRUE)
    EVT_CALL(SetPlayerActionState, ACTION_STATE_LAND)
    EVT_CALL(SetPlayerPos, -260, -161, 12)
    EVT_CALL(SetNpcPos, 2,  -91, -181, 20)
    EVT_CALL(SpeakToPlayer, 2, ANIM_WorldEldstar_Talk, ANIM_WorldEldstar_Idle, 5, MSG_Space_OpeningScene1)
    ...
    EVT_CALL(SpeakToPlayer, 3, ANIM_JrTroopa_Talk, ANIM_JrTroopa_Idle, 5, MSG_Space_OpeningScene2)
    EVT_CALL(SpeakToPlayer, 2, ANIM_WorldEldstar_Talk, ANIM_WorldEldstar_Idle, 5, MSG_Space_OpeningScene3)
    EVT_CALL(SetMusicTrack, 0, SONG_JR_TROOPA_THEME, 0, 8 )
    EVT_WAIT(2)
    EVT_CALL(SetNpcAnimation, 3, ANIM_JrTroopa_Walk)
    EVT_CALL(NpcFlyTo, 3, 260, 0, 12, 15, 0, 0)
    EVT_CALL(SetNpcAnimation, 3, ANIM_JrTroopa_Idle)
    EVT_CALL(SpeakToPlayer, 3, ANIM_JrTroopa_Talk, ANIM_JrTroopa_Idle, 5, MSG_Space_OpeningScene4)
    EVT_CALL(SpeakToPlayer, 2, ANIM_WorldEldstar_Talk, ANIM_WorldEldstar_Idle, 5, MSG_Space_OpeningScene5)
    EVT_CALL(MakeLerp, MV_ShipPosX, 0, 30, EASING_LINEAR)
    EVT_LOOP(0)
        EVT_CALL(GetPlayerPos, LVar3, LVar4, LVar5)
        EVT_CALL(UpdateLerp)
        EVT_SET(MV_ShipPosX, LVar0)
        EVT_SET(LVar3, MV_ShipPosX)
        EVT_SUB(LVar3, 12)
    ...
    EVT_CALL(SpeakToPlayer, 3, ANIM_JrTroopa_Talk, ANIM_JrTroopa_Idle, 5, MSG_Space_OpeningScene6)
    EVT_CALL(SetMusicTrack, 0, SONG_JR_TROOPA_BATTLE, 0, 8 )
    EVT_SET(GF_StartedSpaceShip, TRUE)
    EVT_CALL(SetNpcAnimation, 3, ANIM_JrTroopa_ChargeArmsUp)
